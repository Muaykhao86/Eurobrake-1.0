        ...
        <StyledPage className="Discover">
            ...
            <div className="grid ">
                <div className="grid_item grid_item-yellow">
                    ...
                    <Typography className="grid_text grid_text-blue Discover-reg"><span className="Discover-bold" >2,513</span> hours of sunlight a year</Typography>
                </div>
                <div className="grid_item grid_item-blue">
                    <Museum style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-yellow Discover-reg"><span className="Discover-bold" >55</span> museums</Typography>
                </div>
                <div className="grid_item grid_item-yellow">
                    <Beach style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-blue Discover-reg" ><span className="Discover-bold" >4.5km</span> of beach</Typography>
                </div>
                <div className="grid_item grid_item-blue">
                    <Globe style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-yellow Discover-reg"><span className="Discover-bold" >9</span> world heritage sites</Typography>
                </div>
                <div className="grid_item grid_item-yellow">
                    <ChefHat style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-blue Discover-reg"><span className="Discover-bold" >24</span> Michelin-starred restuarants</Typography>
                </div>
                <div className="grid_item grid_item-blue">
                    <Cart style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-yellow Discover-reg"><span className="Discover-bold" >43</span> markets</Typography>
                </div>
                <div className="grid_item grid_item-yellow">
                    <People style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-blue Discover-reg"><span className="Discover-bold" >50</span> theatres</Typography>
                </div>
                <div className="grid_item grid_item-blue">
                    <Music style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-yellow Discove-regr"><span className="Discover-bold" >9</span> music festivals</Typography>
                </div>
                <div className="grid_item grid_item-yellow">
                    <KF style={{ marginBottom: '2rem' }} />
                    <Typography className="grid_text grid_text-blue Discover-reg"><span className="Discover-bold" >5,913</span> restaurants</Typography>
                </div>
            </div>
            <div className="">
