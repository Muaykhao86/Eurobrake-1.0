...
const DemoDiv = styled_components__WEBPACK_IMPORTED_MODULE_5___default.a.form.withConfig({
...
const Demo = styled_components__WEBPACK_IMPORTED_MODULE_5___default.a.h1.withConfig({
  displayName: "authorsArea__Demo",
  componentId: "sc-17gi1ng-1"
})(["padding:10rem;margin:5rem;color:orangered;"]);

class AuthorsArea extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(props) {
    super(props);
  }
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_utils_auth__WEBPACK_IMPORTED_MODULE_6__["withAuthSync"])(AuthorsArea));
...
const logout = () => {
  js_cookie__WEBPACK_IMPORTED_MODULE_7___default.a.remove("token"); // To trigger the event listener we save some random data into the `logout` key
