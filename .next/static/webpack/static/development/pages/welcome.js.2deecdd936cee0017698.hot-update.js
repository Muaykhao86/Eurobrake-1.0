...
})(["border:10px solid white;position:absolute;right:-20rem;top:-5rem;display:flex;align-items:flex-start;justify-content:flex-start;flex-flow:column;padding:2rem;transition:all .8s ease-in-out;opacity:", ";transform:", ";min-width:99vw;min-height:99vh;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:27vh;}.nav_container-1{width:100%;border:10px solid white;height:100%;display:flex;flex-flow:row;flex:1 1 auto;align-items:flex-start;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){margin-top:0;}}.nav-inner{display:flex;flex-flow:column;&-title{font-size:1.8rem;font-family:", ";color:", ";}&-text{font-size:1.8rem;font-family:", ";color:", ";}}.nav_box-1{width:100%;max-height:20rem;flex:1 1 auto;border:10px solid white;display:flex;flex-flow:column;justify-content:flex-start;align-items:flex-start;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){padding:0;margin:0;}}.nav_box-middle{height:50rem;flex:1 1 auto;border:10px solid white;padding:2rem;margin:2rem;display:flex;flex-flow:row;&-1{}&-2{}&-3{}}.nav_box-right{border:10px solid white;height:50rem;max-width:30rem;flex:1 1 auto;margin:2rem;display:flex;flex-flow:column;align-items:center;justify-content:space-between;}.nav_box-left{border:10px solid white;height:50rem;max-width:30rem;flex:1 1 auto;margin:2rem;display:flex;flex-flow:column;align-items:center;justify-content:space-between;}"], function (props) {
...
//# sourceMappingURL=welcome.js.2deecdd936cee0017698.hot-update.js.map