...
})(["color:white;position:fixed;background-color:", ";min-width:100%;height:10rem;display:flex;justify-content:flex-end;align-items:center;z-index:100;border-bottom:5px solid ", ";.logo{position:absolute;left:8rem;}.head{width:60rem;position:absolute;left:20rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:center;&-title{font-size:1.8rem;font-family:", ";color:", ";max-width:90%;}&-text{font-size:1.8rem;font-family:", ";color:", ";max-width:90%;}}"], function (props) {
...
//# sourceMappingURL=index.js.aede8bc5feed260b2299.hot-update.js.map