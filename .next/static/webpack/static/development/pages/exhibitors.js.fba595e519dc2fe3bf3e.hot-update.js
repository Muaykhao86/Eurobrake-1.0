...
})(["position:fixed;top:50%;bottom:50%;margin-top:-50vh;margin-bottom:-50vh;right:0;max-width:", ";max-height:", ";background-color:", ";padding:2rem;display:flex;flex-flow:column;justify-content:space-between;font-size:2rem;.Dates{&-title{font-size:3rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-date{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
  return props.MW || '33rem';
}, function (props) {
  return props.MW || '15rem';
}, function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBlack;
...
//# sourceMappingURL=exhibitors.js.fba595e519dc2fe3bf3e.hot-update.js.map