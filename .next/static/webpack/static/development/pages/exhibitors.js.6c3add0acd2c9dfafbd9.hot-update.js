...
})(["display:flex;flex-flow:column;justify-content:space-between;margin:1rem;width:27rem;min-height:37rem;padding:0 1rem;.MuiPaper-elevation1{box-shadow:0px 15px 5px 2px rgba(0,0,0,0.2),0px 5px 5px 0px rgba(0,0,0,0.14),0px 1px 3px 0px rgba(0,0,0,0.12);}"]);
...
//# sourceMappingURL=exhibitors.js.6c3add0acd2c9dfafbd9.hot-update.js.map