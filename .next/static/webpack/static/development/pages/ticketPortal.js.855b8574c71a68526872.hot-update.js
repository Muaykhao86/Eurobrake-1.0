...
})(["max-width:", ";height:", ";background-color:", ";padding:1rem;display:flex;flex:1 1 auto;flex-flow:column;justify-content:space-between;font-size:2rem;.Dates{&-title{font-size:3rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-date{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
  return props.MW || '33rem';
}, function (props) {
  return props.MH || '33rem';
}, function (props) {
...
//# sourceMappingURL=ticketPortal.js.855b8574c71a68526872.hot-update.js.map