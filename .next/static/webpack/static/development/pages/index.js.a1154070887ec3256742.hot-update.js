...
})(["position:absolute;top:", ";left:", ";margin:0 1rem;width:4rem;height:4rem;cursor:pointer;display:flex;align-items:center;z-index:300;transition:all 10s linear;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:8rem;height:8rem;left:", ";}"], function (props) {
  return props.isOpen ? '-2rem' : '-4rem';
}, function (props) {
  return props.isOpen ? '-2rem' : '-6rem';
}, function (props) {
  return props.isOpen ? '-6rem' : '-6rem';
});
var trans = {
...
//# sourceMappingURL=index.js.a1154070887ec3256742.hot-update.js.map