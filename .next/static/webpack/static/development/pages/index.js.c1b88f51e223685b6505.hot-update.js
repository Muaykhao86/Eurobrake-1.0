...
})(["min-width:100%;min-height:", ";@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:", ";}display:flex;flex-flow:column;justify-content:space-between;.banner{display:flex;flex:1 1 20%;}"], function (props) {
...
})(["position:relative;overflow:hidden;flex:2 1 80%;"]);
...
})(["  display:flex;img{width:100%;height:100%;}"]);
...
//# sourceMappingURL=index.js.c1b88f51e223685b6505.hot-update.js.map