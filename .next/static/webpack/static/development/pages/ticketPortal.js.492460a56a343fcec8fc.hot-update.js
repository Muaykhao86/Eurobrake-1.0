...
})(["display:flex;flex-flow:column;font-size:7rem;line-height:1rem;font-family:", ";margin:0 1rem;span{margin-left:1.5rem;font-size:1.7rem;font-family:", ";}"], function (props) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CountDownBanner, [{
    ...
    value: function componentDidMount() {
      ...
      this.interval = setInterval(function () {
        ...
        var days = Math.floor(distance / (1000 * 60 * 60 * 24)).toFixed(3);
        var hours = Math.floor(distance / (1000 * 60 * 60) % 24).toFixed(2);
        var minutes = Math.floor(distance / (1000 * 60) % 60).toFixed(2);
        var seconds = Math.floor(distance / 1000 % 60).toFixed(2);
...
//# sourceMappingURL=ticketPortal.js.492460a56a343fcec8fc.hot-update.js.map