...
})(["border:10px solid white;position:absolute;right:-15rem;top:0;display:flex;align-items:flex-start;justify-content:flex-start;flex-flow:row wrap;padding:2rem;margin:2rem;transition:all .8s ease-in-out;opacity:", ";transform:", ";min-width:98vw;min-height:98vh;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:27vh;}.nav_container-1{border:10px solid white;margin-top:5rem;height:100%;display:flex;flex-flow:row;flex:1 1 auto;align-items:flex-start;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){margin-top:0;}}.Nav-title{margin-left:1rem;}.nav_box-1{max-height:20rem;flex:1 1 auto;border:10px solid white;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:flex-start;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){padding:0;margin:0;}}.nav_box-2{max-height:70rem;flex:1 1 auto;border:10px solid white;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:center;align-items:flex-start;}.nav_box-3{border:10px solid white;min-height:55rem;width:25rem;flex:1 1 auto;margin:2rem;display:flex;flex-flow:column;align-items:center;justify-content:space-between;}"], function (props) {
...
//# sourceMappingURL=welcome.js.7e0af3906d85c3d65a9f.hot-update.js.map