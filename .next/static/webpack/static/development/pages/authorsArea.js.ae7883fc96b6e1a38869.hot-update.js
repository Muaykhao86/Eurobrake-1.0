...
var ResetSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  new_password: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').min(8, 'Password must be a least 8 charecters long'),
  password: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').min(8, 'Password must be a least 8 charecters long')
});
...
//# sourceMappingURL=authorsArea.js.ae7883fc96b6e1a38869.hot-update.js.map