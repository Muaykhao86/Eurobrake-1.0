...
var AreAbstracts =  false || Abstracts;
...
var Abstract = function Abstract() {
  return __jsx(StyledBox, {
    ...
    __self: this
  }, Abstracts[0].papercode), __jsx(_components_Button__WEBPACK_IMPORTED_MODULE_25__["Button"], {
    bcolor: "#134381",
    background: "#134381",
    br: "100rem",
    padding: "0.5rem 2rem",
    ...
    __self: this
  }, Abstracts[2].title), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_16__["default"], {
    gutterBottom: true,
    ...
    __self: this
  }, Abstracts[2].paper_type.toUpperCase()), Abstracts[2].tasks && Abstracts[2].tasks.map(function (task) {
    return __jsx("div", {
...
//# sourceMappingURL=authorsAreaDash.js.a3d666e2b8e2b13f8b13.hot-update.js.map