...
})(["display:flex;max-width:", ";justify-content:baseline;margin-right:2rem;"], function (props) {
...
})(["position:relative;display:flex;flex-flow:column;align-items:flex-start;font-size:7rem;font-family:", ";margin:0 1rem;span{position:absolute;top:9rem;font-size:1.7rem;font-family:", ";padding-left:1rem;}span:not(.noPad){padding-left:4rem;}"], function (props) {
...
//# sourceMappingURL=exhibitorsRegistration.js.26accffdcc93baf2e5d1.hot-update.js.map