...
})(["display:flex;flex-flow:column;align-self:center;margin-top:5rem;max-width:", ";background-color:", ";h1{font-family:", ";color:", ";font-size:4.4rem;}"], function (props) {
...
var StyledBanner = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "welcome__StyledBanner",
  componentId: "sc-1nteme0-1"
...
var StyledContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "welcome__StyledContainer",
  componentId: "sc-1nteme0-2"
})(["display:flex;flex-flow:column;width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:4.4rem;padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";}.banner-sub{font-family:", ";font-size:3.8rem;font-weight:50;}.banner_bottom{display:flex;align-self:flex-end;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.maxWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_HeroSection__WEBPACK_IMPORTED_MODULE_5__["default"], {
    ...
    __self: this
  }, "Welcome to Barcelona section"), __jsx(StyledPage, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 92
    },
...
//# sourceMappingURL=welcome.js.9e22fc1fe883665ff7b6.hot-update.js.map