...
function _SendForm() {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(_ref2) {
    var csrf, formData, url, form, _cookie$get3, logintoken, apiUrl, response, data, error, _response, _data, _logintoken, _error;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 24:
            ...
            _context3.prev = 25;
            _context3.next = 28;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()('https://prelude.eurobrake.net/login', {
              method: 'POST',
              credentials: 'include',
              body: form,
              headers: {
...
//# sourceMappingURL=authorsArea.js.e25009ef34ce0750c0e6.hot-update.js.map