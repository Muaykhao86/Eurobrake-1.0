...
var getFormData = function getFormData(values) {
  return _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_2___default()(values).reduce(function (formData, key) {
...
function _SendFile() {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(_ref2) {
    var values, url, _cookie$get2, logintoken, _getFormData, formData;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            values.copyright && values.copyright === true ? values.copyright = 'yes' : null; // const formData = new FormData();

            _cookie$get2 = js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get(), logintoken = _cookie$get2.logintoken;
            _getFormData = getFormData(values), formData = _getFormData.formData;
            console.log(formData); // console.log(values.typeOf())
...
//# sourceMappingURL=studentArea.js.7ccd69f176e25adad7ec.hot-update.js.map