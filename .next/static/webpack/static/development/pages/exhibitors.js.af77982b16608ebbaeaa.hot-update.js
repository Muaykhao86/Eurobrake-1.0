...
})(["position:fixed;top:10vh;bottom:50%;margin-top:-50vh;margin-bottom:-50vh;right:0;width:25rem;max-height:50rem;background-color:", ";padding:2rem;display:flex;flex-flow:column;justify-content:space-between;flex:1 1 auto;font-size:2rem;.Dates{&-title{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-date{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=exhibitors.js.af77982b16608ebbaeaa.hot-update.js.map