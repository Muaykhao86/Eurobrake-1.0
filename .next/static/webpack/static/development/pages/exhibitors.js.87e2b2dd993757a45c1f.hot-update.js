...
})(["position:fixed;z-index:1;top:14vh;right:0;width:25rem;max-height:50rem;background-color:", ";padding:2rem;display:flex;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:none;}flex-flow:column;justify-content:space-between;flex:1 1 auto;font-size:2rem;.Dates{&-title{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-date{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=exhibitors.js.87e2b2dd993757a45c1f.hot-update.js.map