    ...
    return __jsx(_Formstyles__WEBPACK_IMPORTED_MODULE_8__["StyledForm"], {
      ...
      return Q4.map(function (question) {
        return __jsx("div", {
          ...
          __self: this
        }, question.id), console.log(values), __jsx(formik__WEBPACK_IMPORTED_MODULE_2__["Field"], {
          checked: values.question_4_answer.includes(question.value),
          onChange: function onChange(e) {
            e.target.checked ? push(question.value) : remove(values.question_4_answer.value);
          },
...
var emptyInitial = {
  ...
  question_2_answer: '',
  question_3_answer: '',
  question_4_answer: ["A19B58F6-20D0-11EA-9309-935393B87AAD"],
  __csrf_token: ''
};
...
//# sourceMappingURL=esop.js.f1594b59e132e525f7e9.hot-update.js.map