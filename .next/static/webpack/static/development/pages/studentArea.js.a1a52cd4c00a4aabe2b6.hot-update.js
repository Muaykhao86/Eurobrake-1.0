...
var BioSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  biography: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').test('wordCount', 'Min 100 words', function (value) {
    return value.match(/\S+/g).length() >= 100;
  }).required('Required')
});
...
//# sourceMappingURL=studentArea.js.a1a52cd4c00a4aabe2b6.hot-update.js.map