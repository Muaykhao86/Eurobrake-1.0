...
})(["position:relative;width:100%;height:.2rem;transition:all 6s ease;background-color:", ";&:before{width:100%;height:100%;position:absolute;top:-1.2rem;transition:top .2s ease-out,transform .22s cubic-bezier(.215,.61,.355,1) .12s;content:'';transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transition:all .2s ease-out;top:1.2rem;}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=_app.js.23a3fb353a6aa64da201.hot-update.js.map