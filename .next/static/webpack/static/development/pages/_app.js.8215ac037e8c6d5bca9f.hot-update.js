...
var BunFun = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["keyframes"])(["100%{top:0;}"]);
...
})(["position:relative;width:100%;height:.2rem;background-color:", ";&:before{width:100%;height:100%;position:absolute;top:-1.2rem;content:'';border-bottom:2px solid ", ";animation:", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';top:1.2rem;animation:", " .2s ease-out;}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.isOpen ? "".concat(BunFun, " .2s ease-out") : null;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, BunFun);
...
//# sourceMappingURL=_app.js.8215ac037e8c6d5bca9f.hot-update.js.map