...
})(["position:absolute;z-index:10;top:20%;align-self:center;width:", ";line-height:", ";color:", ";text-align:center;text-shadow:0px 4px 7px rgba(0,0,0,0.74);&&.MuiTypography-body1{font-size:", ";@media only screen  and (max-device-width:1200px)  and (-webkit-min-device-pixel-ratio:2){font-size:9rem;}@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){font-size:", ";width:", ";}font-family:", ";}"], function (props) {
  return props.max || '80%';
}, function (props) {
  return props.LH || '1';
}, function (props) {
...
//# sourceMappingURL=exhibitAndSponsor.js.c4e8073d1c3ebca607c0.hot-update.js.map