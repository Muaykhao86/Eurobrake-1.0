...
var PaperSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  accept: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().test('accept', 'Field must be checked', function (value) {
    return value === 'yes';
  }).required('Required'),
...
var PPTSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  ...
  ppt_filename: yup__WEBPACK_IMPORTED_MODULE_0__["mixed"]().required('Required').test("fileSize", "File too large", function (value) {
...
var PitchVideoSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  pitchvideo_filename: yup__WEBPACK_IMPORTED_MODULE_0__["mixed"]().required('Required').test("fileSize", "File too large", function (value) {
    return value && value.size <= FILE_SIZE;
  }).test("fileFormat", "Unsupported Format", function (value) {
    return value && PPT_SUPPORTED_FORMATS.includes(value.type);
  }),
...
var BioSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  biography: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').test('wordCount', 'Max 100 words', function (value) {
    return value && value.match(/[\w\d\’\'-]+/gi).length <= 100;
  } // split(' ').length <= 100 
  ).test('wordCount', 'Min 20 words', function (value) {
    return value && value.match(/[\w\d\’\'-]+/gi).length >= 20;
  } // split(' ').length <= 100 
  )
});
...
//# sourceMappingURL=studentArea.js.d6ed8dd7b65215deec18.hot-update.js.map