...
})(["position:relative;width:100%;height:.2rem;transition:all .8s cubic-bezier(0.22,0.61,0.36,1) .8s;background-color:", ";transform:", ";&:before{width:100%;height:100%;position:absolute;border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=_app.js.7397c6ce644ae2a87a99.hot-update.js.map