...
})(["display:flex;flex-direction:column;flex-wrap:wrap;align-self:center;margin-top:10rem;max-width:", ";h1{margin:2rem;text-transform:uppercase;}"], function (props) {
...
})(["display:flex;flex-direction:column;max-height:50rem;align-items:center;justify-content:space-between;h1{align-self:flex-start;}"]);
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(ExhibitorList, [{
    ...
    value: function render() {
      var exhibitors = this.props.exhibitors.exhibitors.exhibitors;
      return __jsx(StyledExhibitors, {
        __source: {
...
//# sourceMappingURL=exhibitors.js.ba5d101446fcde7632f0.hot-update.js.map