...
})(["width:100%;height:100%;display:flex;flex:1;flex-flow:column;align-items:center;margin-top:5rem;justify-content:stretch;.paper{padding:2rem;margin:2rem;width:30vw;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:70vw;}}.closeBtn{transform:rotate(45deg);font-size:2.5rem;}.ModalLogo{width:50%;margin-bottom:2rem;}.ModalTitle{font-family:", ";font-size:2.1rem;color:", ";}.ModalContact{font-family:", ";font-size:1.1rem;margin-right:.5rem;}.ModalIcon{font-size:2.5rem;transform:translateY(-1rem);}.ModalSummary{max-height:15rem;font-family:", ";font-size:1.1rem;padding-top:1rem;overflow:scroll;}.ModalBooth{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}.ModalMapTitle{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}"], function (props) {
...
})(["border:1px solid ", ";align-self:center;overflow:hidden;svg{.findMe{fill:#134381;animation:1s ", " ease-in-out infinite;}}"], function (props) {
  return props.theme.primary;
}, fadeIn);
...
//# sourceMappingURL=exhibitors.js.726106304a26ac938f04.hot-update.js.map