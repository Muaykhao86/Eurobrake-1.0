...
})(["display:flex;flex-flow:column;width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:3.4rem;padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";}.banner-sub{font-family:", ";font-size:3.8rem;font-weight:50;}.banner_bottom{display:flex;align-self:flex-end;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.maxWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=studentArea.js.846a8ba6d9561f756893.hot-update.js.map