      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              S = _Snap__WEBPACK_IMPORTED_MODULE_9__["default"]; // Snap.UseSnap();
              // let SelectSnap = Snap.SelectSnap()

              console.log('map', mapRef); //  let s =  await Snap('#svg');
              //  console.log({s})
...
//# sourceMappingURL=exhibitors.js.0ca4c4f86f68f12f51c9.hot-update.js.map