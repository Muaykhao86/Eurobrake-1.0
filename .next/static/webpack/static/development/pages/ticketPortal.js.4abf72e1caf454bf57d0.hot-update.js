...
})(["display:flex;flex-flow:column;align-self:center;margin-top:5rem;width:", ";background-color:", ";h1{font-family:", ";color:", ";font-size:4.4rem;}"], function (props) {
...
})(["align-self:center;display:flex;flex-flow:column;justify-content:center;justify-items:center;margin-top:10rem;min-width:80rem;min-height:70rem;border:5px solid ", ";background-color:transparent;padding:3rem;text-decoration:none;"], function (props) {
  return props.theme.primary;
});
...
//# sourceMappingURL=ticketPortal.js.4abf72e1caf454bf57d0.hot-update.js.map