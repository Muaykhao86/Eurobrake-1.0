...
})(["display:flex;flex-flow:column;align-self:center;width:", ";background-color:", ";margin-top:7rem;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:", ";}h1{font-family:", ";color:", ";font-size:4.4rem;}"], function (props) {
...
})(["background-color:#134381;min-width:100%;display:flex;justify-content:flex-start;align-items:center;color:white;"]);
...
})(["display:flex;flex-flow:column;align-items:center;min-width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:", ";padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";}.banner-sub{font-family:", ";font-size:", ";font-weight:50;}.banner_bottom{display:flex;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.minWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=authorsArea.js.61f9a3bbe2e81ab8335f.hot-update.js.map