...
})(["position:relative;padding-top:10rem;z-index:10;min-width:100%;min-height:", ";display:flex;flex-flow:column;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2)  and (orientation:portrait){min-height:", ";}.white-reveal{position:absolute;bottom:0;right:0;width:20rem;height:5rem;background-color:", ";}.white-reveal_left{position:absolute;bottom:0;left:0;width:20rem;height:5rem;background-color:", ";}.hero-img{max-height:80%;flex:2 1 80%;object-fit:cover;}.banner{display:flex;}"], function (props) {
...
//# sourceMappingURL=index.js.003da73ec1b06f0f281e.hot-update.js.map