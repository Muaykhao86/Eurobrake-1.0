...
var ResetSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  ...
  confirm_password: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').min(8, 'Password must be a least 8 characters long').test(values.confirm_password === vallues.new_password, 'Passwords must match')
});
...
//# sourceMappingURL=authorsArea.js.20b64ce5abbb60dab31e.hot-update.js.map