...
})(["position:relative;width:100%;height:.2rem;background-color:", ";&:before{width:100%;height:100%;position:absolute;top:-1.2rem;content:'';border-bottom:2px solid ", ";transition:", " 2s ease-in-out;}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';top:1.2rem;animation:", " 2s ease;}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
...
//# sourceMappingURL=_app.js.9a11af9f68463e58712e.hot-update.js.map