...
var ResetForm = function ResetForm(props) {
  ...
  return __jsx(formik__WEBPACK_IMPORTED_MODULE_4__["Formik"], {
    ...
    var allTouched = function allTouched() {
      _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_2___default()(values).forEach(function (key) {
        setTouched(values[key], true);
      });
    };
    ...
    return __jsx(_Formstyles__WEBPACK_IMPORTED_MODULE_6__["StyledForm"], {
      ...
      onClick: function onClick() {
        return allTouched().validateForm().then(function (errors) {
...
//# sourceMappingURL=authorsArea.js.0a7fb8af32829a15e722.hot-update.js.map