...
/*!*****************************************!*\
  !*** ./components/forms/TaskControl.js ***!
  \*****************************************/
/*! exports provided: PaperSchema, PPTSchema, PermissionSchema, PitchVideoSchema, AcceptPosterSchema, PosterSchema, BioSchema */
...
var BioSchema = yup__WEBPACK_IMPORTED_MODULE_0__["object"]().shape({
  biography: yup__WEBPACK_IMPORTED_MODULE_0__["bool"]().test('accept', 'Field must be checked', function (value) {
    return value === true;
  }).required('Required'),
  poster_filename: yup__WEBPACK_IMPORTED_MODULE_0__["mixed"]().required('Required').test("fileFormat", "Unsupported Format", function (value) {
    return value && PPT_SUPPORTED_FORMATS.includes(value.type);
  }),
  author_notes: yup__WEBPACK_IMPORTED_MODULE_0__["string"]().required('Required').test()
});

/***/ })

})
//# sourceMappingURL=studentArea.js.d7131a5bcb2a07e5d4f8.hot-update.js.map