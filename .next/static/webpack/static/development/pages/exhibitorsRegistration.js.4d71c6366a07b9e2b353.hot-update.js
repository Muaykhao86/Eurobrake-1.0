...
})(["display:flex;flex-flow:column;align-self:center;margin-top:", ";max-width:", ";background-color:", ";margin-top:7rem;h1{font-family:", ";color:", ";font-size:4.4rem;}"], function (props) {
...
})(["display:flex;flex-flow:column;width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:", ";padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";}.banner-sub{font-family:", ";font-size:", ";font-weight:50;}.banner_bottom{display:flex;align-self:flex-end;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.maxWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=exhibitorsRegistration.js.4d71c6366a07b9e2b353.hot-update.js.map