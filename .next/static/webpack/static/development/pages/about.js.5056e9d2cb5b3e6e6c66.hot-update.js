...
})(["display:flex;flex-flow:column;max-width:12.7rem;overflow:hidden;.profile{margin:2.5rem 0;font-size:1.4rem;color:", ";&-mediabox{}&_description{display:flex;flex-flow:column;align-items:center;&-title{font-family:", ";}&-subtitle{font-family:", ";text-align:center;}}}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBold;
}, function (props) {
...
//# sourceMappingURL=about.js.5056e9d2cb5b3e6e6c66.hot-update.js.map