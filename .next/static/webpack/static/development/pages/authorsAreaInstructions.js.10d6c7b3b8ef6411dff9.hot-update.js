...
})(["display:flex;flex-flow:column;align-items:flex-start;min-width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:", ";padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";}.banner-sub{font-family:", ";font-size:", ";font-weight:50;}.banner_bottom{display:flex;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.minWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=authorsAreaInstructions.js.10d6c7b3b8ef6411dff9.hot-update.js.map