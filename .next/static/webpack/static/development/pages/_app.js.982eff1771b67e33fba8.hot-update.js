...
})(["position:absolute;right:-15rem;top:0;display:flex;padding:2rem;margin:2rem;transition:all .8s ease-in-out;opacity:", ";transform:", ";min-width:90vw;min-height:90vh;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:30rem;}@media only screen  and (max-device-width:500px)  and (-webkit-min-device-pixel-ratio:2){flex-flow:column;margin:0;}.Nav-title{font-size:4rem;@media only screen  and (max-device-width:1200px)  and (-webkit-min-device-pixel-ratio:2){font-size:2.3rem;}}.Nav-title{margin-left:1rem;}.nav_box-1{flex:1 1 auto;width:25rem;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:flex-start;}.nav_box-2{flex:1 1 auto;width:25rem;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:flex-end;align-items:flex-start;}.nav_box-3{width:3rem;flex:1 1 auto;border:2px solid white;padding:2rem;margin:2rem;background-color:goldenrod;display:flex;flex-flow:column;justify-content:space-between;}.nav_box-4{flex:1 1 auto;padding:2rem;margin:2rem;background-color:sandybrown;min-height:15rem;min-width:15rem;}.nav_box-5{flex:1 1 auto;border:2px solid white;padding:2rem;margin:2rem;min-height:15rem;min-width:15rem;}.nav_box-6{border:2px solid white;padding:2rem;margin:2rem;min-height:15rem;min-width:15rem;}"], function (props) {
...
//# sourceMappingURL=_app.js.982eff1771b67e33fba8.hot-update.js.map