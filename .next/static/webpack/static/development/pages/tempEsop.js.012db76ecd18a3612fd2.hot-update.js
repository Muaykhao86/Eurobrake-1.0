...
})(["display:flex;flex-flow:column;justify-content:space-between;align-items:center;min-width:100%;a{cursor:pointer;font-family:", ";color:", ";}.MuiInput-underline:before{color:", ";}.MuiInput-underline:after{color:", ";}.MuiFormHelperText-root{font-size:1.5rem;}.MuiInputBase-root{font-family:", ";font-size:2rem;color:", ";}.form{display:flex;&-secondary{display:flex;flex-flow:column;justify-content:space-between;align-items:center;min-width:100%;}&-radio{margin:2rem 0;align-self:flex-end;text-align:end;}&-field{position:relative;margin:2rem 0;width:100%;display:flex;font-family:", ";justify-content:space-between;align-items:flex-end;&_question{width:100%;margin:1rem 0;display:flex;flex-flow:column;}&_file{display:flex;flex-flow:column;&-box{width:100%;margin:5rem 0;display:flex;justify-content:space-between;.MuiInput-underline:before{border-bottom:none;}}&_action{align-self:flex-end;display:flex;justify-content:flex-end;align-items:flex-end;}}&-radio{position:relative;width:100%;display:flex;flex-flow:column;margin:1rem 0;}&-copy{width:100%;display:flex;flex-flow:column;}&_action{align-self:flex-end;display:flex;justify-content:flex-end;align-items:flex-end;}}&-notes{font-family:", ";position:relative;display:flex;flex-flow:column;justify-content:space-between;align-items:center;min-width:100%;&-label{min-width:100%;font-family:", ";font-size:2.6rem;color:", ";}&-input{margin:5rem 0;min-width:100%;min-height:15rem;font-family:", ";font-size:2rem;color:", ";}}&-checkboxField{position:relative;min-width:100%;font-family:", ";font-size:2.6rem;color:", ";display:flex;align-items:center;justify-content:space-between;margin:2rem 0;.MuiIconButton-colorSecondary:hover{background-color:transparent;}.MuiSvgIcon-root{font-size:4rem;}&-box{align-self:flex-end;}}&-label{align-self:flex-start;min-width:33.3%;font-family:", ";font-size:2.6rem;color:", ";}&-input{align-self:flex-end;width:66.6%;font-family:", ";font-size:2rem;color:", ";&_question{width:66.66%;align-self:flex-end;margin:5rem 0;}&_file{width:100%;font-family:", ";font-size:2rem;color:", ";.MuiInput-underline:before{border-bottom:none;}}}&-link{cursor:pointer;font-family:", ";font-size:1.7rem;color:", ";}&-link_bold{cursor:pointer;font-family:", ";color:", ";}&-title{color:", ";font-family:", ";font-size:3rem;align-self:flex-start;margin:2rem 0;}}"], function (props) {
...
//# sourceMappingURL=tempEsop.js.012db76ecd18a3612fd2.hot-update.js.map