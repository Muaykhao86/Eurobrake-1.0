  ...
  return (// ! NEED PRESETS FOR TASKS
    __jsx(formik__WEBPACK_IMPORTED_MODULE_5__["Formik"], {
      ...
      return __jsx(_TaskStyles__WEBPACK_IMPORTED_MODULE_9__["StyledTask"], {
        ...
        label: {
          label: "I have used the templates available in the <Link href=\"/authorsAreaInstructions\"><a className=\"task-link_bold\" >Instructions and Templates</a></Link> section of the Author\u2019s Area and I have also followed the guidance notes available there."
        },
        ...
        label: {
          label: 'I agree to assign copyright in this paper to FISITA (UK) Ltd.'
        },
        onClick: handleChange,
        className: "task-checkboxField-box",
...
//# sourceMappingURL=studentArea.js.8e7502d3b23cdd1459a8.hot-update.js.map