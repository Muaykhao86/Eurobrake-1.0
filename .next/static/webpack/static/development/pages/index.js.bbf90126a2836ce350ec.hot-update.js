...
})(["max-width:100%;max-height:100%;background-color:", ";padding:2rem;border-right:5px solid ", ";display:flex;flex:1 1 auto;flex-flow:column;justify-content:space-between;font-size:2rem;.Box{&-title{font-size:2.8rem;font-family:", ";color:", ";align-self:center;}&-date{font-size:1.8rem;font-family:", ";color:", ";align-self:center;}&-text{font-size:1.8rem;font-family:", ";color:", ";align-self:center;}&-text-it{font-size:2.5rem;font-family:", ";color:", ";align-self:center;}}.logo_box{height:10rem;display:flex;align-items:center;justify-content:center;flex:1 1 auto;}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=index.js.bbf90126a2836ce350ec.hot-update.js.map