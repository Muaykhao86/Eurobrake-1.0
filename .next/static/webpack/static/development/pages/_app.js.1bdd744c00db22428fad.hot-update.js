...
})(["position:relative;width:100%;height:.2rem;transition:all 6s ease;background-color:", ";&:before{width:100%;height:100%;position:absolute;transform:translateY(-1.2rem);content:'';transition:all .2s ease-out;transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transform:translateY(1.2rem);transition:all .2s ease-out;transform:", "}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.isOpen ? trans.up : trans.stay;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
...
//# sourceMappingURL=_app.js.1bdd744c00db22428fad.hot-update.js.map