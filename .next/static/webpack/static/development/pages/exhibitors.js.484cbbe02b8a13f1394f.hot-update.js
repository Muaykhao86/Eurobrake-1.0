...
})(["min-width:37.9rem;min-height:22.9rem;border:1px solid ", ";align-self:center;svg{.findMe{fill:#134381;&:before{content:'look at me!';font-size:3rem;display:inline-block;color:goldenrod;}}}"], function (props) {
  return props.theme.primary;
});
function ServerModal(props) {
  ...
  var Zoom = function Zoom() {
    setSnap(__webpack_require__(/*! snapsvg */ "./node_modules/snapsvg/dist/snap.svg.js"));
    console.log(Snap);
  };
...
//# sourceMappingURL=exhibitors.js.484cbbe02b8a13f1394f.hot-update.js.map