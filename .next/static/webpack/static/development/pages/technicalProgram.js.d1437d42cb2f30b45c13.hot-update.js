...
function TechExpandTable() {
  ...
  function createData(time, session) {
    return {
      time: time,
      session: session
    };
  ...
  var tuesday = [createData('10:00–12:00', 'Student Introductory Lecture'), createData('10:30–12:30', 'Registration and light lunch'), createData('13:00–13:15', 'Opening Ceremony'), createData('13:15–13:25', 'Student Opportunities Programme at EuroBrake'), createData('13:25–14:25', 'Opening Plenary Session'), createData('14:00–14:20', 'Break'), createData('14:40–16:00', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('16:00–16:20', 'Break'), createData('16:20–18:00', 'Technical Sessions'), createData('', 'Fundamentals: Big Data Analytics and Uncertainty'), createData('', 'Innovative Raw Materials'), createData('', 'Innovative Technologies and Functions in Electronic Brake Systems'), createData('18:00–19:30', 'Welcome Reception')];
  var wednesday = [createData('08:30–10:10', 'Technical Sessions'), createData('', 'New Brake Control Strategies'), createData('', 'Fundamentals: Friction, Wear and Brake Emissions'), createData('', 'Squeal Noise: Simulation and Test Methods'), createData('10:10–10:40', 'Break'), createData('10:40–12:20', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('12:20–13:50', 'Lunch'), createData('12:30–13:30', 'Open Seminar'), createData('13:50–15:30', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('15:30–16:00', 'Break'), createData('16:00–17:40', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('18:00–19:00', 'Drinks Reception'), createData('19:00–22:30', 'EuroBrake Dinner including Awards')];
  var thursday = [createData('08:30–10:10', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('10:10–10:40', 'Break'), createData('10:40–12:20', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('12:20–13:20', 'Lunch'), createData('13:20–15:00', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('15:00–15:30', 'Break'), createData('15:30–17:10', 'Technical Sessions'), createData('', 'Brake Components in Transition'), createData('', 'Creep-groan Noise'), createData('', 'Electrification of Commercial Vehicles and Effects on Pneumatic Braking Systems'), createData('17:10–18:10', 'Farewell Drinks Reception')];
  return __jsx("div", {
    __source: {
...
//# sourceMappingURL=technicalProgram.js.d1437d42cb2f30b45c13.hot-update.js.map