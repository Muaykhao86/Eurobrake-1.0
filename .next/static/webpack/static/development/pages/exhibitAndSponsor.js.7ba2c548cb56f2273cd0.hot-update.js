...
})(["display:flex;flex-direction:column;align-self:center;width:", ";background-color:", ";margin-top:7rem;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:", ";}.Exhibit{color:", ";font-family:", ";font-size:2rem;&-title{color:", ";font-family:", ";font-size:4.4rem;margin-top:3rem;}&_list{list-style-type:none;list-style-position:inside;margin-bottom:1rem;}&_list-title{margin-bottom:1rem;font-family:", ";font-size:2rem;}&_sub-title{color:", ";font-size:3.5rem;font-family:", ";padding-bottom:.5rem;}&-bold{font-family:", ";}&-italic{font-family:", "}&-boldIt{font-family:", "}}.infoBox{display:flex;flex-flow:column;justify-content:center;min-height:24rem;background-color:", ";width:100vw;position:relative;left:50%;right:50%;margin-left:-50.5vw;margin-right:-50.5vw;&-text{align-self:center;width:50%;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:80%;};}}.margin-bottom{margin-bottom:1.5rem;}"], function (props) {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_components_HeroSection__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    __self: this
  }, "A range of sought-after sponsorship packages are available to help position your company as a leader in the braking technology world."), __jsx(_components_Button__WEBPACK_IMPORTED_MODULE_6__["Button"], {
    background: "#134381",
    br: "100rem",
    bcolor: "#134381",
    style: {
    ...
    __self: this
  }, "For more information please contact FISITA: "), __jsx(_components_Icons__WEBPACK_IMPORTED_MODULE_7__["PhoneIcon"], {
    width: "30px",
    height: "30px",
    __source: {
      fileName: _jsxFileName,
    ...
    __self: this
  }), " sales@fisita.com")), __jsx(_components_Button__WEBPACK_IMPORTED_MODULE_6__["Button"], {
    background: "#134381",
    br: "100rem",
    bcolor: "#134381",
    style: {
...
//# sourceMappingURL=exhibitAndSponsor.js.7ba2c548cb56f2273cd0.hot-update.js.map