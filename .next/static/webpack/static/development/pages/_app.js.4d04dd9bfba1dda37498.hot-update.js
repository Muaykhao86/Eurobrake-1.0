...
})(["position:relative;width:100%;height:.2rem;transition:all cubic-bezier(0.22,0.61,0.36,1) .8s;background-color:", ";transform:", ";&:before{width:100%;height:100%;position:absolute;transition:top .2s ease-out,transform 6s cubic-bezier(.215,.61,.355,1) 3s;top:", ";content:'';transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transition:all .2s ease-out;top:", ";}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=_app.js.4d04dd9bfba1dda37498.hot-update.js.map