...
})(["position:fixed;top:10vh;bottom:50%;margin-top:-50vh;margin-bottom:-50vh;right:0;width:25rem;min-height:25rem;background-color:", ";padding:2rem;display:flex;flex-flow:column;justify-content:space-between;font-size:2rem;.Dates{&-title{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-date{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:1.5rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=exhibitors.js.3563b9d1332d94135255.hot-update.js.map