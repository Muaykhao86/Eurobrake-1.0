...
})(["width:100%;height:100%;display:flex;flex:1;flex-flow:column;justify-content:center;align-items:center;margin-top:5rem;.paper{padding:2rem;margin:2rem;@media ", "{max-width:50rem;}}.closeBtn{transform:rotate(45deg);font-size:2.5rem;}.ModalLogo{width:50%;margin-bottom:2rem;}.ModalTitle{font-family:", ";font-size:2.1rem;color:", ";}.ModalContact{font-family:", ";font-size:1.1rem;margin-right:.5rem;}.ModalIcon{transform:translateY(-1rem);width:80%;}.ModalSummary{max-height:15rem;font-family:", ";font-size:1.1rem;padding-top:1rem;overflow:scroll;}.ModalBooth{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}.ModalMapTitle{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}"], _Page__WEBPACK_IMPORTED_MODULE_12__["device"].tablet, function (props) {
...
//# sourceMappingURL=exhibitors.js.ded90a107d64c3dc940a.hot-update.js.map