...
var Paper = function Paper(props) {
  ...
  return (// ! NEED PRESETS FOR TASKS
    __jsx(formik__WEBPACK_IMPORTED_MODULE_5__["Formik"], {
      ...
      var validateMyForm = function validateMyForm(errors) {
        console.log(errors);
      };
      ...
      return __jsx(_TaskStyles__WEBPACK_IMPORTED_MODULE_9__["StyledTask"], {
        ...
        __self: this
      }, errors.copyright)), __jsx(_Button__WEBPACK_IMPORTED_MODULE_7__["Button"], {
        onClick: function onClick() {
          return validateForm().then(function (errors) {
            return errors.length > 0 && onSubmit();
          });
        },
        bcolor: "#134381",
        background: "#134381",
...
//# sourceMappingURL=studentArea.js.baced7a83addfda9f45c.hot-update.js.map