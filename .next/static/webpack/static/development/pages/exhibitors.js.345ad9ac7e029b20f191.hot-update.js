...
})(["width:100%;height:100%;display:flex;flex:1;flex-flow:column;justify-content:center;align-items:center;margin-top:5rem;@media ", "{justify-content:stretch;align-content:stretch;}.paper{padding:2rem;margin:2rem;@media ", "{max-width:50rem;}}.closeBtn{transform:rotate(45deg);font-size:2.5rem;}.ModalLogo{width:50%;margin-bottom:2rem;}.ModalTitle{font-family:", ";font-size:2.1rem;color:", ";}.ModalContact{font-family:", ";font-size:1.1rem;margin-right:.5rem;}.ModalIcon{transform:translateY(-1rem);width:80%;}.ModalSummary{max-height:15rem;font-family:", ";font-size:1.1rem;padding-top:1rem;overflow:scroll;}.ModalBooth{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}.ModalMapTitle{font-family:", ";font-size:1.7rem;color:", ";padding:1rem 0;}"], _Page__WEBPACK_IMPORTED_MODULE_12__["device"].mobileS, _Page__WEBPACK_IMPORTED_MODULE_12__["device"].tablet, function (props) {
...
})(["min-width:37.9rem;min-height:22.9rem;border:1px solid ", ";align-self:center;overflow:hidden;svg{.findMe{fill:#134381;animation:1s ", " ease-in-out infinite;}}"], function (props) {
  return props.theme.primary;
}, fadeIn);
...
//# sourceMappingURL=exhibitors.js.345ad9ac7e029b20f191.hot-update.js.map