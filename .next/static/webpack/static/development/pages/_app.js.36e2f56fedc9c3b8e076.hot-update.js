...
var BunFun = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["keyframes"])(["100%{transform:rotate(-90deg);}"]);
...
})(["position:relative;width:100%;height:.2rem;transition:all 6s ease;background-color:", ";&:before{width:100%;height:100%;position:absolute;transition:top .2s ease-out,transform .22s cubic-bezier(.215,.61,.355,1) .12s;content:'';top:-1.2rem;transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transform:translateY(1.2rem);transition:all .2s ease-out;transform:", "}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.isOpen ? rotate(-90) : rotate(0);
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
  return props.isOpen ? trans.down : trans.stay;
});
...
//# sourceMappingURL=_app.js.36e2f56fedc9c3b8e076.hot-update.js.map