...
})(["position:relative;padding-top:10rem;z-index:10;min-width:100%;min-height:", ";display:flex;flex-flow:column;align-items:center;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:", ";}img{flex:2 1 80%;object-fit:cover;}.banner{display:flex;}"], function (props) {
...
})(["position:absolute;z-index:10;top:20%;align-self:center;width:", ";line-height:", ";color:", ";text-align:center;text-shadow:0px 4px 7px rgba(0,0,0,0.74);&&.MuiTypography-body1{font-size:", ";@media only screen  and (max-device-width:1200px)  and (-webkit-min-device-pixel-ratio:2){font-size:9rem;}@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){font-size:", ";width:", ";}font-family:", ";line-height:1;}"], function (props) {
  return props.max || '80%';
}, function (props) {
  return props.LH || '1';
}, function (props) {
...
//# sourceMappingURL=exhibitAndSponsor.js.8a52e7f289f133735538.hot-update.js.map