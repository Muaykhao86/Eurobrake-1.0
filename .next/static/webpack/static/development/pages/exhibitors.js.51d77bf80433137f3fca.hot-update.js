...
})(["position:relative;min-width:100%;min-height:", ";@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:", ";}display:flex;flex-flow:column;img{flex:2 1 80%;object-fit:cover;}.banner{display:flex;}"], function (props) {
...
//# sourceMappingURL=exhibitors.js.51d77bf80433137f3fca.hot-update.js.map