...
})(["display:flex;flex-flow:column;align-items:center;min-width:", ";padding:3rem 0;.banner-heading{font-family:", ";font-size:", ";padding-bottom:.5rem;margin-bottom:.5rem;border-bottom:2px solid ", ";align-self:flex-start;}.banner-sub{font-family:", ";font-size:", ";font-weight:50;align-self:flex-start;}.banner_bottom{display:flex;align-self:flex-start;&-icon{color:", ";font-size:1.5rem;background-color:white;border:1px solid white;border-radius:50%;margin:.5rem;}&-details{font-family:", ";font-size:1.6rem;}}"], function (props) {
  return props.theme.minWidth;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=authorsAreaInstructions.js.48e8698f22a952999f1a.hot-update.js.map