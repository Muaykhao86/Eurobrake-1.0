...
})(["position:relative;top:0;left:50%;right:50%;margin-left:-50.5vw;margin-right:-50.5vw;background-color:", ";width:", ";height:", ";border:1px solid ", ";align-self:center;overflow:hidden;svg{.findMe{fill:#134381;animation:1s ", " ease-in-out infinite;}}"], function (props) {
...
function ServerModal(props) {
  ...
  var name = props.name,
      ...
      phone = props.phone,
      email = props.email;
  var svgWidth = full ? '80vw' : '';
  var svgHeight = full ? '80vh' : '';
...
//# sourceMappingURL=exhibitors.js.c41c72c34f6aed3785ed.hot-update.js.map