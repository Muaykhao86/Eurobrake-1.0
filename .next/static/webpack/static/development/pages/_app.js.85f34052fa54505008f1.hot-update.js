...
})(["position:relative;width:100%;height:.2rem;transition:all 6s ease;background-color:", ";&:before{width:100%;height:100%;position:absolute;transition:top .2s ease-out;content:'';top:-1.2rem;transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transition:all .2s ease-out;top:1.2rem;}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=_app.js.85f34052fa54505008f1.hot-update.js.map