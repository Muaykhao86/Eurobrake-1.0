...
})(["position:absolute;top:'-2rem';left:'-6rem';margin:0 1rem;width:4rem;height:4rem;cursor:pointer;display:flex;align-items:center;z-index:300;transition:all 10s linear;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:8rem;height:8rem;left:", ";top:", ";}"], function (props) {
...
//# sourceMappingURL=index.js.4421dae94c4935f6012c.hot-update.js.map