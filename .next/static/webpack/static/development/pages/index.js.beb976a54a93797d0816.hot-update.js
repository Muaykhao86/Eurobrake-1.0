...
})(["color:white;position:fixed;background-color:", ";min-width:100%;height:10rem;display:flex;justify-content:flex-end;align-items:center;z-index:100;border-bottom:5px solid ", ";.logo{position:absolute;left:8rem;}.head{width:20rem;position:absolute;left:20rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:center;&-title{font-size:2rem;font-family:", ";color:", ";align-self:flex-start;max-width:95%;}&-date{text-align:end;font-size:1.8rem;font-family:", ";color:", ";align-self:flex-end;max-width:90%;}&-text{text-align:end;font-size:1.8rem;font-family:", ";color:", ";align-self:flex-end;max-width:90%;}&-text-it{text-align:end;font-size:1.5rem;font-family:", ";color:", ";align-self:flex-end;max-width:90%;}}"], function (props) {
...
//# sourceMappingURL=index.js.beb976a54a93797d0816.hot-update.js.map