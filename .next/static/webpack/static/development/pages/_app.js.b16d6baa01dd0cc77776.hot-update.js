...
})(["position:relative;width:100%;height:.2rem;transition:transform 1s cubic-bezier(0.22,0.61,0.36,1) 1s;background-color:", ";transform:", ";&:before{width:100%;height:100%;position:absolute;transition:top .2s ease-out,transform .22s cubic-bezier(.215,.61,.355,1) .12s;top:", ";content:'';transform:", ";border-bottom:2px solid ", ";}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';transition:all .2s ease-out;top:", ";}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
}, function (props) {
...
//# sourceMappingURL=_app.js.b16d6baa01dd0cc77776.hot-update.js.map