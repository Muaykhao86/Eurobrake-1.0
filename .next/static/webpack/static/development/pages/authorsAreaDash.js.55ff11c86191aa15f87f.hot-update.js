...
})(["flex:1 1 66.66%;display:flex;flex-flow:column;justify-content:space-between;align-items:flex-start;.paper-title{font-size:2rem;color:", ";}.paper-type{font-size:2rem;color:", ";}.paper_task{color:", ";&-box{display:flex;}}"], function (props) {
  return props.theme.black;
}, function (props) {
  return props.theme.black;
}, function (props) {
...
//# sourceMappingURL=authorsAreaDash.js.55ff11c86191aa15f87f.hot-update.js.map