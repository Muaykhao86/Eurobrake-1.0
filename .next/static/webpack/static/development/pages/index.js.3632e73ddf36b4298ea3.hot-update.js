...
})(["color:white;position:fixed;background-color:", ";min-width:100%;height:10rem;display:flex;justify-content:flex-end;align-items:center;z-index:100;border-bottom:5px solid ", ";.logo{position:absolute;left:8rem;}.head{width:60rem;position:absolute;left:40rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:center;&-title{font-size:1.8rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}&-text{font-size:1.8rem;font-family:", ";color:", ";align-self:flex-start;max-width:90%;}}"], function (props) {
...
//# sourceMappingURL=index.js.3632e73ddf36b4298ea3.hot-update.js.map