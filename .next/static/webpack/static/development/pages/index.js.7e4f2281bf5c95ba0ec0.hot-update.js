...
/*!*****************************!*\
  !*** ./components/Dates.js ***!
  \*****************************/
/*! exports provided: Dates, BounceFixedDates, FixedDates, FixedBox, Box, MoBox */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MoBox", function() { return MoBox; });
...
var StyledMoBox = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  displayName: "Dates__StyledMoBox",
  componentId: "sc-2eodxj-4"
})(["max-width:100%;max-height:100%;background-color:", ";padding:2rem;border-right:5px solid ", ";display:flex;flex:1 1 auto;flex-flow:column;justify-content:space-between;font-size:2rem;.Box{&-title{font-size:2rem;font-family:", ";color:", ";align-self:center;max-width:95%;}&-date{font-size:1.8rem;font-family:", ";color:", ";align-self:center;max-width:90%;}&-text{font-size:1.8rem;font-family:", ";color:", ";align-self:center;max-width:90%;}&-text-it{font-size:1.5rem;font-family:", ";color:", ";align-self:center;max-width:90%;}}.logo_box{height:10rem;display:flex;align-items:center;justify-content:center;flex:1 1 auto;}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.secondary;
}, function (props) {
...
function MoBox(props) {
  return __jsx(StyledMoBox, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 395
    },
    ...
    __self: this
  }, "Secure your tickets by 1 April 2020"), __jsx(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
    href: "/ticketPortal",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 398
...
//# sourceMappingURL=index.js.7e4f2281bf5c95ba0ec0.hot-update.js.map