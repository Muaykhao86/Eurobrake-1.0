...
})(["position:absolute;top:", ";left:", ";margin:0 1rem;width:4rem;height:4rem;cursor:pointer;display:flex;align-items:center;z-index:300;transition:all 10s linear;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){width:8rem;height:8rem;left:2rem;}"], function (props) {
  return props.isOpen ? '-2rem' : '-4rem';
}, function (props) {
  return props.isOpen ? '-2rem' : '-14rem';
});
var trans = {
...
//# sourceMappingURL=index.js.d9c4097e9447ba29d551.hot-update.js.map