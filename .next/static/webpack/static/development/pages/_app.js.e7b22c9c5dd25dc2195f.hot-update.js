...
var BunFun = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["keyframes"])(["50%{top:0;}100%{transform:rotate(-90deg)}"]);
...
})(["position:relative;width:100%;height:.2rem;background-color:", ";animation:", " 2s cubic-bezier(0.22,0.61,0.36,1) 3s ease-in-out;&:before{width:100%;height:100%;position:absolute;top:-1.2rem;content:'';border-bottom:2px solid ", ";animation:", " 2s ease-in-out;}&:after{border-bottom:2px solid ", ";width:100%;height:100%;position:absolute;content:'';top:1.2rem;animation:", " 2s ease-in-out;}"], function (props) {
  return props.sticky ? props.theme.white : props.theme.secondary;
...
//# sourceMappingURL=_app.js.e7b22c9c5dd25dc2195f.hot-update.js.map