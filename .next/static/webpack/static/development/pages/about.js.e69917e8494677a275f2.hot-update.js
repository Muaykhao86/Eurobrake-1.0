...
})(["position:absolute;right:-15rem;top:0;display:flex;padding:2rem;margin:2rem;transition:all .8s ease-in-out;opacity:", ";transform:", ";min-width:90vw;min-height:90vh;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:30rem;}.nav_container-1{display:flex;flex-flow:row wrap;flex:1 1 auto;}.Nav-title{margin-left:1rem;}.nav_box-1{flex:1 1 auto;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:flex-start;align-items:flex-start;}.nav_box-2{max-height:70rem;flex:1 1 auto;padding:2rem;margin:2rem;display:flex;flex-flow:column;justify-content:center;align-items:flex-start;}.nav_box-3{max-height:70rem;width:30rem;flex:1 1 auto;border:3px solid ", ";padding:0;margin:2rem;display:flex;flex-flow:column;align-items:flex-end;justify-content:space-between;}"], function (props) {
...
//# sourceMappingURL=about.js.e69917e8494677a275f2.hot-update.js.map