...
})(["position:relative;min-width:100%;min-height:", ";@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:", ";}display:flex;flex-flow:column;.banner{display:flex;flex:1 1 20%;}"], function (props) {
...
})(["position:relative;overflow:hidden;flex:1 1 100%;"]);
...
})(["  display:flex;flex:1;object-fit:cover;img{flex:1;object-fit:cover;width:100%;height:100%;}"]);
...
//# sourceMappingURL=index.js.23468630ac6dd488d6ee.hot-update.js.map