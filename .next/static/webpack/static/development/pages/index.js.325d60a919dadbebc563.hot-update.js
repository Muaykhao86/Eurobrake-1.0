...
})(["position:relative;padding-top:10rem;z-index:10;min-width:100%;min-height:", ";display:flex;flex-flow:column;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2)  and (orientation:portrait){min-height:", ";}.white-reveal{position:absolute;bottom:-5rem;right:0;width:26rem;height:5rem;background:linear-gradient(90deg,rgba(255,0,0,.8),rgba(255,0,0,0) 70.71%);}.white-reveal_left{position:absolute;bottom:-5rem;left:0;width:26rem;height:5rem;background-color:", ";}.hero-img{max-height:80%;flex:2 1 80%;object-fit:cover;}.banner{display:flex;}"], function (props) {
...
//# sourceMappingURL=index.js.325d60a919dadbebc563.hot-update.js.map