...
})(["max-width:100%;max-height:100%;background-color:", ";padding:2rem;display:flex;flex:1 1 auto;flex-flow:column;justify-content:space-between;font-size:2rem;.Box-mob{&-title{font-size:3rem;font-family:", ";color:", ";align-self:center;}&-date{font-size:1.8rem;font-family:", ";color:", ";align-self:center;}&-text{font-size:1.8rem;font-family:", ";color:", ";align-self:center;}&-text-it{font-size:2.5rem;font-family:", ";color:", ";align-self:center;}}.logo_box-mob{height:10rem;display:flex;align-items:center;justify-content:center;flex:1 1 auto;}"], function (props) {
  return props.theme.primary;
}, function (props) {
  return props.theme.MPBlack;
}, function (props) {
...
//# sourceMappingURL=index.js.2224600d27871759e3f9.hot-update.js.map