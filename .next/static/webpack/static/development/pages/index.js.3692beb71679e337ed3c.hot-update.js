...
})(["display:flex;flex-flow:column;justify-content:flex-start;margin:0 10rem;margin-top:5rem;margin-bottom:15rem;@media ", " and (-webkit-min-device-pixel-ratio:2){width:", ";}@media ", "{width:", ";}@media ", " and (-webkit-min-device-pixel-ratio:2){width:", ";}@media ", "{width:", ";}@media ", "{width:", ";}h1{font-family:", ";font-size:4.4rem;color:", ";line-height:1.1;margin-bottom:3rem;}p{font-family:", ";font-size:2rem;color:", ";margin-bottom:1rem;}.innerContainer{position:relative;display:flex;flex-flow:column;margin-top:2rem;}.mediaBox{min-width:66.4rem;max-height:33rem;overflow:hidden;display:flex;justify-content:center;align-items:center;}"], _Page__WEBPACK_IMPORTED_MODULE_1__["device"].mobileS, function (props) {
  return props.theme.tabletWidth;
}, _Page__WEBPACK_IMPORTED_MODULE_1__["device"].mobileS, function (props) {
  return props.theme.tabletWidth;
}, _Page__WEBPACK_IMPORTED_MODULE_1__["device"].laptop, function (props) {
  return props.theme.laptopWidth;
}, _Page__WEBPACK_IMPORTED_MODULE_1__["device"].laptop, function (props) {
  return props.theme.laptopWidth;
}, _Page__WEBPACK_IMPORTED_MODULE_1__["device"].laptopL, function (props) {
...
//# sourceMappingURL=index.js.3692beb71679e337ed3c.hot-update.js.map