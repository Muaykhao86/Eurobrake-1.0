...
})(["border:10px solid white;position:absolute;right:-20rem;top:-5rem;display:flex;align-items:flex-start;justify-content:flex-start;flex-flow:column;padding:2rem;transition:all .8s ease-in-out;opacity:", ";transform:", ";min-width:99vw;min-height:99vh;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){min-height:27vh;}.nav{&-title{width:40%;font-size:2rem;font-family:", ";color:", ";&-box{display:flex;flex-flow:column;align-items:flex-start;margin-bottom:3rem;}}&-links{font-size:2rem;font-family:", ";color:", ";&-box{display:flex;flex-flow:column;align-items:flex-start;margin-bottom:5rem;}}&_container-1{width:100%;border:10px solid white;height:100%;display:flex;flex-flow:row;flex:1 1 auto;align-items:flex-start;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){margin-top:0;}}&-inner{display:flex;flex-flow:column;&-title{font-size:3rem;font-family:", ";color:", ";}&-text{font-size:3rem;font-family:", ";color:", ";}}&_box-1{margin-left:5rem;padding:2rem;width:70%;max-height:20rem;flex:1 1 auto;border:10px solid white;display:flex;justify-content:space-between;align-items:flex-end;@media only screen  and (max-device-width:768px)  and (-webkit-min-device-pixel-ratio:2){padding:0;margin:0;}}&_box-middle{height:50rem;flex:1 1 auto;border:10px solid white;margin:2rem;display:flex;flex-flow:row;justify-content:space-between;&-1{display:flex;flex-flow:column;width:30rem;height:48rem;}&-2{width:30rem;height:48rem;}&-3{width:30rem;height:48rem;}}&_box-right{border:10px solid white;height:50rem;max-width:30rem;flex:1 1 auto;margin:2rem;display:flex;flex-flow:column;align-items:center;justify-content:space-between;}&_box-left{border:10px solid white;height:50rem;max-width:30rem;flex:1 1 auto;margin:2rem;display:flex;flex-flow:column;align-items:center;justify-content:space-between;}}"], function (props) {
...
//# sourceMappingURL=index.js.8cdc97e85031b2b0c0fd.hot-update.js.map