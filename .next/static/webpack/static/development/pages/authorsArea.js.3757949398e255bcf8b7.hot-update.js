...
})(["display:flex;flex-flow:column;justify-content:space-between;align-items:center;min-width:100%;.MuiInput-underline:after{color:", ";}.MuiFormHelperText-root{font-size:1.5rem;}.MuiInputBase-root{font-family:", ";font-size:2rem;color:", ";}.form{&-secondary{display:flex;flex-flow:column;justify-content:space-between;align-items:center;min-width:100%;}&-field{margin:1rem 0;width:100%;display:flex;justify-content:space-between;align-items:flex-end;}&-label{font-family:", ";font-size:2.6rem;color:", ";}&-input{min-width:40rem;font-family:", ";font-size:2rem;color:", ";}&-link{font-family:", ";font-size:1.7rem;color:", ";}&-radio{text-align:end;}&-title{color:", ";font-family:", ";font-size:3rem;align-self:flex-start;margin:2rem 0;}}"], function (props) {
...
//# sourceMappingURL=authorsArea.js.3757949398e255bcf8b7.hot-update.js.map